  ...
  [
    module.loop('main-loop', module.block(null, [
      ...
      module.if(
        ...
        // longer
        module.return(
          module.get_local(6, Binaryen.i32)
        )
      ),
      ...
      module.set_local(2, module.get_local(4, Binaryen.f32)),
      module.set_local(3, module.get_local(5, Binaryen.f32)),
      module.br('main-loop')
    ])),
  ],
  Binaryen.none
...
module.addFunction('mandelbrot', iff, [Binaryen.f32, Binaryen.f32, Binaryen.f32, Binaryen.f32, Binaryen.i32], body);
